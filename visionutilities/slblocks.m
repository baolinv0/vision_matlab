...
blkStruct.Name    = sprintf('Computer Vision\nSystem Toolbox');
blkStruct.OpenFcn = 'visionlib';
...
blkStruct.MaskDisplay = ['plot(' ...
        ...
        '[0.938 0.938 0.776 NaN 0.857 0.776 0.857 NaN 0.776 0.776 ' ...
         ...
         'text(0.6,0.75,''VISION'');'];

% Define the library list for the Simulink Library browser.
% Return the name of the library model and the name for it
Browser(1).Library = 'visionlib';
Browser(1).Name    = 'Computer Vision System Toolbox';
Browser(1).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?

blkStruct.Browser = Browser;

% Define information about Signal Generators                               
Generator(1).Library = 'vipgenerators_all';
Generator(1).Name    = 'Computer Vision System Toolbox';                
blkStruct.Generator = Generator;                                           

%% Define information for model updater
blkStruct.ModelUpdaterMethods.fhUpdateModel = @vipblksUpdateModel;
blkStruct.ModelUpdaterMethods.fhDetermineBrokenLinks = @vipblksBrokenLinksMapping;
