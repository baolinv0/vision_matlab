/*
 *  OPTICALFLOW_HS_R_RT runtime function for Optical Flow Block
 *  (Horn & Schunck method).
 *
                                        ...
                                        int_T  inCols)
{
    ...
    real32_T *outVelR     = (real32_T *)velR;
    ...
    for( i = 0; i < inSize; i++ )
    {
        outVel[i] = outVelC[i]*outVelC[i] + outVelR[i]*outVelR[i];
    }
}

/* [EOF] opticalflow_hs_r_rt.c */
