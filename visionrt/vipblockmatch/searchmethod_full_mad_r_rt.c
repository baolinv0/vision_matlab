/*
 *  SEARCHMETHOD_FULL_MAD_R_RT Helper function for Block Matching block.
 *
 *  Copyright 1995-2008 The MathWorks, Inc.
 */
#include "vipblockmatch_rt.h"  

LIBMWVISIONRT_API void MWVIP_SearchMethod_Full_MAD_R(const real32_T *blkCS, const real32_T *blkPB, /* CS = current image (smaller block), PB = previous image (bigger block) */
...
/* [EOF] searchmethod_full_mad_r_rt.c */
