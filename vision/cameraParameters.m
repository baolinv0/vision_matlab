classdef cameraParameters < vision.internal.calibration.CameraParametersImpl & matlab.mixin.CustomDisplay
    ...
    %                          Default: [0 0]
    %
    %   'ImageSize'            Image size produced by the camera and specified 
    %                          as [mrows, ncols].
    %
    %                          Default: []
    %
    ...
    methods(Access=protected)
        ...
        function group = getPropertyGroups(~)
            ...
            list1 = {'IntrinsicMatrix', 'FocalLength', 'PrincipalPoint', ...
                'Skew', 'RadialDistortion', 'TangentialDistortion', 'ImageSize'};
