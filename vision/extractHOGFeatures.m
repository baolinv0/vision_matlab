...
%  coordinates, SURFPoints, KAZEPoints, cornerPoints, MSERRegions, or
%  BRISKPoints. Any scale information associated with the points is
%  ignored. The class of validPoints is the same as the input points.
%
...
% cornerPoints, MSERRegions, BRISKPoints, int16, uint16, int32, uint32,
% single, or double.
%
%
